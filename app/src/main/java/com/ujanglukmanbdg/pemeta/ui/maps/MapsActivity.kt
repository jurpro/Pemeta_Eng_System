...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.maps_back -> {
                intent = Intent(this@MapsActivity, LandingPageActivity::class.java)
